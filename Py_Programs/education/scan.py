...
class Scan():
    def __init__(self):
        ...
        self.style.configure('TButton', foreground='white', background='#1c1c1c')
        ...
        ip_label = ttk.Label(self.window, text="Enter IP Address:")
        ip_label.pack()

        ip_entry = ttk.Entry(self.window, style='TEntry', width=50)
        ip_entry.pack()
        ...
        output_text = ScrolledText(self.window, height=17, width=80, bg='grey', fg='white')
        output_text.pack()
