...
class PonkyPy(QtWidgets.QWidget):
    def __init__(self):
        ...
        self.cpu_label.setContentsMargins(0, 0, 0, 0)  # Set the label's margin to 0
        ...
        self.ram_label.setContentsMargins(0, 0, 0, 0)  # Set the label's margin to 0
        ...
        self.disk_label.setContentsMargins(0, 0, 0, 0)  # Set the label's margin to 0
        ...
        self.network_label.setContentsMargins(0, 0, 0, 0)  # Set the label's margin to 0
        ...
        # self.uptime_info.setContentsMargins(0, 0, 0, 0)  # Set the label's margin to 0
    ...
    def update_meter(self):
        ...
        # self.uptime_info.setText(f"System Uptime: {uptime}")

        # User Info
        # user_info = psutil.users()[0].name
        # self.user_info.setText(f"User Information: {user_info}")
